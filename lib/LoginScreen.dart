              ...
              decoration: const BoxDecoration(
                ...
                borderRadius: BorderRadius.only(
                  bottomLeft: Radius.circular(
                      200), // This radius should be half of the width.
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    decoration: InputDecoration(
                      ...
                      contentPadding: const EdgeInsets.symmetric(
                          horizontal: 12,
                          vertical: 8), // Adjust the padding to change size
                    ...
                    items: <String>['Student', 'Faculty', 'Security', 'Admin']
                      ...
                      return DropdownMenuItem<String>(
                        alignment: Alignment
                            .center, // Centers the text in the dropdown menu
                        value: value,
                        child: Text(value),
                      );
                    }).toList(),
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        fillColor: const Color(
                            0xff5BBAFF), // Ensure this matches the container's color
